...
import { runChapter as runChapter38 } from "./11_项目实战/chapter38_代码组织与规范.js";
import { runChapter as runChapter39 } from "./11_项目实战/chapter39_项目1_文件批处理CLI/main.js";
import { runChapter as runChapter40 } from "./11_项目实战/chapter40_项目2_日志分析CLI/main.js";
...
export const CHAPTERS: Chapter[] = [
    ...
    },
    {
        ...
        title: "ch38 代码组织与规范",
        phase: "项目实战",
        path: "11_项目实战/chapter38_代码组织与规范.ts",
        run: runChapter38
    },
    {
        id: 39,
        title: "ch39 项目1 文件批处理 CLI",
        phase: "项目实战",
        path: "11_项目实战/chapter39_项目1_文件批处理CLI/main.ts",
        run: runChapter39
    },
    {
        id: 40,
        title: "ch40 项目2 日志分析 CLI",
        phase: "项目实战",
        path: "11_项目实战/chapter40_项目2_日志分析CLI/main.ts",
        run: runChapter40
    },
    {
        id: 41,
