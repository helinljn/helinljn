...
5. `05_标准库篇`：系统、文本、时间、数据结构、正则、网络与 HTTP、数值工具、文件目录工具、类型注解进阶、日志、调试
6. `06_并发与数据库`：并发编程、SQLite
7. `07_项目实战`：代码组织、文件批量处理工具、日志分析系统

每章建议先通读源码注释，再运行示例，最后完成对应练习。
...
python "05_标准库篇\chapter21_网络与HTTP基础.py"
python "05_标准库篇\chapter21_补充1_数学与数值工具.py"
python "05_标准库篇\chapter21_补充2_文件目录工具.py"
python "05_标准库篇\chapter21_补充3_类型注解进阶.py"
...
- 章节烟雾测试：第 11 章异常处理主流程、异常处理最佳实践、ExceptionGroup
- 网络章节：URL 解析、本地 HTTP 服务、本地 TCP socket、网络异常处理
- 标准库补充：数值工具、文件目录工具、类型注解进阶
- 项目1：文件搜索、演练重命名、内容替换
- 项目2：Apache/Nginx 日志行解析、文件解析统计、SQLite 数据分析、CLI 报告生成
