...
FILE(GLOB_RECURSE CURRENT_DIR_INCLUDE_LIST
    ${CMAKE_PROJECT_ROOT_DIR}/3rd/tinyxml2/tinyxml2.h
)
...
IF(${CMAKE_SYSTEM_NAME} MATCHES "Windows")
    ...
    SOURCE_GROUP(TREE ${CMAKE_PROJECT_ROOT_DIR}/3rd/tinyxml2 PREFIX "include"
        FILES ${CURRENT_DIR_INCLUDE_LIST})
    SOURCE_GROUP(TREE ${CMAKE_PROJECT_ROOT_DIR}/3rd/tinyxml2 PREFIX "src"
