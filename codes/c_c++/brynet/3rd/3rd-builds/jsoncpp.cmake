...
IF(${CMAKE_SYSTEM_NAME} MATCHES "Windows")
    ...
    SOURCE_GROUP(TREE ${CMAKE_PROJECT_ROOT_DIR}/3rd/jsoncpp/include PREFIX "include"
        FILES ${CURRENT_DIR_INCLUDE_LIST})
    SOURCE_GROUP(TREE ${CMAKE_PROJECT_ROOT_DIR}/3rd/jsoncpp/src/lib_json PREFIX "src"
