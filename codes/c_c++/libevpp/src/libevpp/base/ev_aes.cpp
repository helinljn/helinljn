...
// AES-128
//////////////////////////////////////////////////////////////////////////
static inline void AES128_init(AES128_ctx* ctx, const uint8* key16)
{
	return AES_setup(ctx->rk, key16, 4, 10);
}

static inline void AES128_encrypt(const AES128_ctx* ctx, size_t blocks, uint8* cipher16, const uint8* plain16)
{
	while (blocks--)
	{
...
static inline void AES128_decrypt(const AES128_ctx* ctx, size_t blocks, uint8* plain16, const uint8* cipher16)
{
	while (blocks--)
	{
...
// AES-256
//////////////////////////////////////////////////////////////////////////
static inline void AES256_init(AES256_ctx* ctx, const uint8* key32)
{
	return AES_setup(ctx->rk, key32, 8, 14);
}

static inline void AES256_encrypt(const AES256_ctx* ctx, size_t blocks, uint8* cipher16, const uint8* plain16)
{
	while (blocks--)
	{
...
static inline void AES256_decrypt(const AES256_ctx* ctx, size_t blocks, uint8* plain16, const uint8* cipher16)
{
	while (blocks--)
	{
