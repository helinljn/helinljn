...
POCO_OPENSSL_DIR=$POCO_INIT_DIR/../../server/3rd/3rd-libs/openssl-1.1.1t/x64-ubuntu-20.04/include
...
sed -i 's/Zip-libexec: Foundation-libexec Net-libexec Util-libexec XML-libexec/Zip-libexec: Foundation-libexec/g' Makefile
