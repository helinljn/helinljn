...
void test_memory_and_hex_convert(void)
{
    ...
    std::string hex_string_upper = convert_memory_to_hex_string(&local_tm, sizeof(local_tm), true);
    std::string hex_string_lower = convert_memory_to_hex_string(&local_tm, sizeof(local_tm), false);
