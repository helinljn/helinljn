...
{
    ASSERT_TRUE(numeric_cast::from_string<int8_t>("0") == 0);
    ASSERT_TRUE(numeric_cast::from_string<int8_t>("000") == 0);
    ASSERT_TRUE(numeric_cast::from_string<int8_t>("123") == 123);
    ASSERT_TRUE(numeric_cast::from_string<int8_t>("-123") == -123);
    ASSERT_TRUE(numeric_cast::from_string<int8_t>("1234") == -46); // overflow

    ASSERT_TRUE(numeric_cast::from_string<uint8_t>("0") == 0);
    ASSERT_TRUE(numeric_cast::from_string<uint8_t>("000") == 0);
    ASSERT_TRUE(numeric_cast::from_string<uint8_t>("123") == 123);
    ASSERT_TRUE(numeric_cast::from_string<uint8_t>("-123") == 133); // negative
    ASSERT_TRUE(numeric_cast::from_string<uint8_t>("1234") == 210); // overflow

    ASSERT_TRUE(numeric_cast::from_string<int16_t>("0") == 0);
    ASSERT_TRUE(numeric_cast::from_string<int16_t>("000") == 0);
    ASSERT_TRUE(numeric_cast::from_string<int16_t>("12345") == 12345);
    ASSERT_TRUE(numeric_cast::from_string<int16_t>("-12345") == -12345);
    ASSERT_TRUE(numeric_cast::from_string<int16_t>("123456") == -7616); // overflow

    ASSERT_TRUE(numeric_cast::from_string<uint16_t>("0") == 0);
    ASSERT_TRUE(numeric_cast::from_string<uint16_t>("000") == 0);
    ASSERT_TRUE(numeric_cast::from_string<uint16_t>("12345") == 12345);
    ASSERT_TRUE(numeric_cast::from_string<uint16_t>("-12345") == 53191); // negative
    ASSERT_TRUE(numeric_cast::from_string<uint16_t>("123456") == 57920); // overflow

    ASSERT_TRUE(numeric_cast::from_string<int32_t>("0") == 0);
    ASSERT_TRUE(numeric_cast::from_string<int32_t>("000") == 0);
    ASSERT_TRUE(numeric_cast::from_string<int32_t>("1234567890") == 1234567890);
    ASSERT_TRUE(numeric_cast::from_string<int32_t>("-1234567890") == -1234567890);

    ASSERT_TRUE(numeric_cast::from_string<uint32_t>("0") == 0);
    ASSERT_TRUE(numeric_cast::from_string<uint32_t>("000") == 0);
    ASSERT_TRUE(numeric_cast::from_string<uint32_t>("1234567890") == 1234567890);

    ASSERT_TRUE(numeric_cast::from_string<int64_t>("0") == 0);
    ASSERT_TRUE(numeric_cast::from_string<int64_t>("000") == 0);
    ASSERT_TRUE(numeric_cast::from_string<int64_t>("1234567890987654321") == 1234567890987654321ll);
    ASSERT_TRUE(numeric_cast::from_string<int64_t>("-1234567890987654321") == -1234567890987654321ll);

    ASSERT_TRUE(numeric_cast::from_string<uint64_t>("0") == 0);
    ASSERT_TRUE(numeric_cast::from_string<uint64_t>("000") == 0);
    ASSERT_TRUE(numeric_cast::from_string<uint64_t>("1234567890987654321") == 1234567890987654321ull);

    ASSERT_TRUE(numeric_cast::from_string<float>("0") == 0.f);
    ASSERT_TRUE(numeric_cast::from_string<float>("0.f") == 0.f);
    ASSERT_TRUE(numeric_cast::from_string<float>("0.0f") == 0.f);
    ASSERT_TRUE(numeric_cast::from_string<float>("0.00") == 0.f);
    ASSERT_TRUE(numeric_cast::from_string<float>("0.000001") == 0.000001f);
    ASSERT_TRUE(numeric_cast::from_string<float>("-1.2345678") == -1.2345678f);
    ASSERT_TRUE(numeric_cast::from_string<float>("-12.345678") == -12.345678f);
    ASSERT_TRUE(numeric_cast::from_string<float>("-123.45678") == -123.45678f);
    ASSERT_TRUE(numeric_cast::from_string<float>("-1234.5678") == -1234.5678f);
    ASSERT_TRUE(numeric_cast::from_string<float>("-12345.678") == -12345.678f);
    ASSERT_TRUE(numeric_cast::from_string<float>("-123456.78") == -123456.78f);
    ASSERT_TRUE(numeric_cast::from_string<float>("-1234567.8") == -1234567.8f);
    ASSERT_TRUE(numeric_cast::from_string<float>("-12345678.") == -12345678.f);
    ASSERT_TRUE(numeric_cast::from_string<float>("-12345678") == -12345678.f);
    ASSERT_TRUE(numeric_cast::from_string<float>("1.2345678") == 1.2345678f);
    ASSERT_TRUE(numeric_cast::from_string<float>("12.345678") == 12.345678f);
    ASSERT_TRUE(numeric_cast::from_string<float>("123.45678") == 123.45678f);
    ...
    ASSERT_TRUE(numeric_cast::from_string<double>("0") == 0.0);
    ASSERT_TRUE(numeric_cast::from_string<double>("0.00") == 0.0);
    ASSERT_TRUE(numeric_cast::from_string<double>("0.000000000000001") == 0.000000000000001);
    ASSERT_TRUE(numeric_cast::from_string<double>("-1.234567890123456") == -1.234567890123456);
    ASSERT_TRUE(numeric_cast::from_string<double>("-12.34567890123456") == -12.34567890123456);
    ASSERT_TRUE(numeric_cast::from_string<double>("-123.4567890123456") == -123.4567890123456);
    ASSERT_TRUE(numeric_cast::from_string<double>("-1234.567890123456") == -1234.567890123456);
    ASSERT_TRUE(numeric_cast::from_string<double>("-12345.67890123456") == -12345.67890123456);
    ASSERT_TRUE(numeric_cast::from_string<double>("-123456.7890123456") == -123456.7890123456);
    ASSERT_TRUE(numeric_cast::from_string<double>("-1234567.890123456") == -1234567.890123456);
    ASSERT_TRUE(numeric_cast::from_string<double>("-12345678.90123456") == -12345678.90123456);
    ASSERT_TRUE(numeric_cast::from_string<double>("-123456789.0123456") == -123456789.0123456);
    ASSERT_TRUE(numeric_cast::from_string<double>("-1234567890.123456") == -1234567890.123456);
    ASSERT_TRUE(numeric_cast::from_string<double>("-12345678901.23456") == -12345678901.23456);
    ASSERT_TRUE(numeric_cast::from_string<double>("-123456789012.3456") == -123456789012.3456);
    ASSERT_TRUE(numeric_cast::from_string<double>("-1234567890123.456") == -1234567890123.456);
    ASSERT_TRUE(numeric_cast::from_string<double>("-12345678901234.56") == -12345678901234.56);
    ASSERT_TRUE(numeric_cast::from_string<double>("-123456789012345.6") == -123456789012345.6);
    ASSERT_TRUE(numeric_cast::from_string<double>("-1234567890123456.") == -1234567890123456.0);
    ASSERT_TRUE(numeric_cast::from_string<double>("-1234567890123456") == -1234567890123456.0);
    ASSERT_TRUE(numeric_cast::from_string<double>("1.234567890123456") == 1.234567890123456);
    ASSERT_TRUE(numeric_cast::from_string<double>("12.34567890123456") == 12.34567890123456);
    ASSERT_TRUE(numeric_cast::from_string<double>("123.4567890123456") == 123.4567890123456);
...
{
    ASSERT_TRUE(numeric_cast::to_string(int8_t{0}) == "0");
    ASSERT_TRUE(numeric_cast::to_string(int8_t{123}) == "123");
    ASSERT_TRUE(numeric_cast::to_string(int8_t{-123}) == "-123");

    ASSERT_TRUE(numeric_cast::to_string(uint8_t{0}) == "0");
    ASSERT_TRUE(numeric_cast::to_string(uint8_t{123}) == "123");

    ASSERT_TRUE(numeric_cast::to_string(int16_t{0}) == "0");
    ASSERT_TRUE(numeric_cast::to_string(int16_t{12345}) == "12345");
    ASSERT_TRUE(numeric_cast::to_string(int16_t{-12345}) == "-12345");

    ASSERT_TRUE(numeric_cast::to_string(uint16_t{0}) == "0");
    ASSERT_TRUE(numeric_cast::to_string(uint16_t{12345}) == "12345");

    ASSERT_TRUE(numeric_cast::to_string(int32_t{0}) == "0");
    ASSERT_TRUE(numeric_cast::to_string(int32_t{1234567890}) == "1234567890");
    ASSERT_TRUE(numeric_cast::to_string(int32_t{-1234567890}) == "-1234567890");

    ASSERT_TRUE(numeric_cast::to_string(uint32_t{0}) == "0");
    ASSERT_TRUE(numeric_cast::to_string(uint32_t{1234567890}) == "1234567890");

    ASSERT_TRUE(numeric_cast::to_string(int64_t{0}) == "0");
    ASSERT_TRUE(numeric_cast::to_string(int64_t{1234567890987654321}) == "1234567890987654321");
    ASSERT_TRUE(numeric_cast::to_string(int64_t{-1234567890987654321}) == "-1234567890987654321");

    ASSERT_TRUE(numeric_cast::to_string(uint64_t{0}) == "0");
    ASSERT_TRUE(numeric_cast::to_string(uint64_t{1234567890987654321}) == "1234567890987654321");

    ASSERT_FALSE(numeric_cast::to_string(float{0.f}).empty());
    ASSERT_FALSE(numeric_cast::to_string(float{0.000001f}).empty());
    ASSERT_FALSE(numeric_cast::to_string(float{-1.2345678f}).empty());
    ASSERT_FALSE(numeric_cast::to_string(float{-12.345678f}).empty());
    ASSERT_FALSE(numeric_cast::to_string(float{-123.45678f}).empty());
    ASSERT_FALSE(numeric_cast::to_string(float{-1234.5678f}).empty());
    ASSERT_FALSE(numeric_cast::to_string(float{-12345.678f}).empty());
    ASSERT_FALSE(numeric_cast::to_string(float{-123456.78f}).empty());
    ASSERT_FALSE(numeric_cast::to_string(float{-1234567.8f}).empty());
    ASSERT_FALSE(numeric_cast::to_string(float{-12345678.f}).empty());
    ASSERT_FALSE(numeric_cast::to_string(float{-12345678}).empty());
    ASSERT_FALSE(numeric_cast::to_string(float{1.2345678f}).empty());
    ASSERT_FALSE(numeric_cast::to_string(float{12.345678f}).empty());
    ASSERT_FALSE(numeric_cast::to_string(float{123.45678f}).empty());
    ASSERT_FALSE(numeric_cast::to_string(float{1234.5678f}).empty());
    ...
    ASSERT_FALSE(numeric_cast::to_string(double{0.0}).empty());
    ASSERT_FALSE(numeric_cast::to_string(double{0.000000000000001}).empty());
    ASSERT_FALSE(numeric_cast::to_string(double{-1.234567890123456}).empty());
    ASSERT_FALSE(numeric_cast::to_string(double{-12.34567890123456}).empty());
    ASSERT_FALSE(numeric_cast::to_string(double{-123.4567890123456}).empty());
    ASSERT_FALSE(numeric_cast::to_string(double{-1234.567890123456}).empty());
    ASSERT_FALSE(numeric_cast::to_string(double{-12345.67890123456}).empty());
    ASSERT_FALSE(numeric_cast::to_string(double{-123456.7890123456}).empty());
    ASSERT_FALSE(numeric_cast::to_string(double{-1234567.890123456}).empty());
    ASSERT_FALSE(numeric_cast::to_string(double{-12345678.90123456}).empty());
    ASSERT_FALSE(numeric_cast::to_string(double{-123456789.0123456}).empty());
    ASSERT_FALSE(numeric_cast::to_string(double{-1234567890.123456}).empty());
    ASSERT_FALSE(numeric_cast::to_string(double{-12345678901.23456}).empty());
    ASSERT_FALSE(numeric_cast::to_string(double{-123456789012.3456}).empty());
    ASSERT_FALSE(numeric_cast::to_string(double{-1234567890123.456}).empty());
    ASSERT_FALSE(numeric_cast::to_string(double{-12345678901234.56}).empty());
    ASSERT_FALSE(numeric_cast::to_string(double{-123456789012345.6}).empty());
    ASSERT_FALSE(numeric_cast::to_string(double{-1234567890123456.0}).empty());
    ASSERT_FALSE(numeric_cast::to_string(double{-1234567890123456}).empty());
    ASSERT_FALSE(numeric_cast::to_string(double{1.234567890123456}).empty());
    ASSERT_FALSE(numeric_cast::to_string(double{12.34567890123456}).empty());
    ASSERT_FALSE(numeric_cast::to_string(double{123.4567890123456}).empty());
    ASSERT_FALSE(numeric_cast::to_string(double{1234.567890123456}).empty());
