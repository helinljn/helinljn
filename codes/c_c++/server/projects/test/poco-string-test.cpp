...
GTEST_TEST(PocoStringTest, TrimLeft)
{
    // trimLeft
    {
        std::string s1 = "abc";
...
GTEST_TEST(PocoStringTest, TrimRight)
{
    // trimRight
    {
        std::string s1 = "abc";
...
GTEST_TEST(PocoStringTest, Trim)
{
    // trim
    {
        std::string s1 = "abc";
...
GTEST_TEST(PocoStringTest, ToUpper)
{
    // toUpper
    {
        std::string s1 = "abc";
...
GTEST_TEST(PocoStringTest, ToLower)
{
    // toLower
    {
        std::string s1 = "ABC";
...
GTEST_TEST(PocoStringTest, Translate)
{
    // translate
    {
...
GTEST_TEST(PocoStringTest, Replace)
{
    // replace
    {
        std::string s("aabbccdd");
...
GTEST_TEST(PocoStringTest, RegularExpression)
{
