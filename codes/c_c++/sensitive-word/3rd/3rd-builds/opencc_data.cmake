...
SET(OPENCC_DATA_ROOT_DIR          ${PROJECT_DEBUGGER_WORKING_DIRECTORY}/data)
...
FOREACH(CONFIG_FILE ${CONFIG_FILES})
    ...
    ADD_CUSTOM_COMMAND(
        ...
        COMMAND
            ${CMAKE_COMMAND} -E copy_directory ${CMAKE_PROJECT_ROOT_DIR}/res ${PROJECT_DEBUGGER_WORKING_DIRECTORY}/res
        DEPENDS
            ${CONFIG_INPUT}
        VERBATIM
    )
