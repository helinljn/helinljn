 ...
 */
CORE_API std::vector<std::string> load_words_from_text(std::string_view text);
 ...
 */
CORE_API std::vector<std::string> load_words_from_file(const std::string& file_path);
